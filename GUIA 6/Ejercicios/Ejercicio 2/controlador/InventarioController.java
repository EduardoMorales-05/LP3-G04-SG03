...
public class InventarioController {
    ...
    // NUEVO MÉTODO: Buscar por número de orden
    ...
    // Método buscarItem original (por nombre)
    ...
    public void usarItem() {
        ...
        if (opcion == 1) {
            ...
            // Usar por número de orden
            vista.mostrarInventario(modelo.obtenerItems());
            System.out.print("Número de orden del item a usar: ");
            int numeroOrden = scanner.nextInt();
            scanner.nextLine();
    ...
    public void ejecutar() {
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 8: vista.mostrarMensaje("¡Hasta luego!"); break;
